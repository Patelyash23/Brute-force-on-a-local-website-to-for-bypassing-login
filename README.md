# Brute-force on a local website to for bypassing login
...
2. Limit Login Attempts With Cross-Check.
...
9. Always Turn-On Your Antivirus.

All thanks to https://github.com/akshatmiglani
